...
- Used to make changes to the DOM before painting the screen, so we don't have to rerender and repaint if we want to scroll, we do it before the screen is painted.
- UseLayoutEffect is triggered before any other effect.
